...
import { getToken, setToken, canTurnTo, setTitle } from "@/libs/tool";

const { HOME_NAME, LOGIN_NAME, NOTFOUND_NAME, NOT_AUTH_NAME } = config.ROUTER;
...
router.beforeEach((to, from, next) => {
  ...
  const { meta: toMeta = {}, name: toName } = to;
