<template>
    <div class="tag-nav-wrapper">
        <div class="tags-nav">
            <div class="btn close-con"><i class="el-icon-circle-close"></i></div>
            <div class="btn prev-con"><i class="el-icon-arrow-right"></i></div>
            <div class="btn next-con"><i class="el-icon-arrow-left"></i></div>
